...
# ============================================================================
AIPS_NUMBER = 309  # AIPS user number
...
fgbchan = [0, 0, 0]  # Beginning channels to flag
fgechan = [0, 0, 0]  # Ending channels to flag
fgbif = [0, 0, 4]  # Beginning IFs to flag
fgeif = [0, 0, 4]  # Ending IFs to flag

# Time flagging
fgtimer=[[0,17,55,0,0,18,31,0],[0,19,57,4,0,19,58,0],[0]]
# Time ranges to flag
...
dwin = 2  # Delay window, centered at 0 and bound is 1/2 value, in nanosec
rwin = 20  # Rate window, centered at 0 and bound is 1/2, in mHz; e.g. 10 = +-5
