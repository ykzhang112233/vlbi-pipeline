...
solint = 4
calsource   = ['3C345']	# calibrator for fringe fitting and bandpass(if used). '' => automatically
...
av_ifs_f1 = 0   # average ifs if is 1 during fring
...
man_fr_file = ['J1905-v2-gsmod1.fits']
#####################mannual flagging################################
do_flag = 1
fgbchan=[0,0]
fgechan=[0,0]
