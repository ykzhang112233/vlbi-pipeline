...
# ============================================================================
AIPS_NUMBER = 314  # AIPS user number
...
file_name = 'bl307c_k.idifits'  # Better use obs_code.idifits as name
...
reference_antenna = 8
search_antennas = [2, 5, 0]
scan_for_fringe = [0,23,24,0,0,23,26,0]
...
# Time flagging
fgtimer=[[0,18,49,0,0,18,51,0],[0,17,38,4,0,17,41,0]]
# Time ranges to flag
...
matxi=[[1.0,1.4,1.0,0.9,1.0,1.1,0.8,1.0,0.9],
       [1.0,1.2,1.1,0.9,0.9,1.1,0.9,1.0,0.9],
       [1.0,1.1,1.0,0.9,0.9,1.0,0.9,1.0,0.8],
       [1.0,1.2,1.0,0.8,0.9,1.2,0.8,0.9,0.9]]
...
# ============================================================================
man_fr_file = ['J1925-v1-mod1.fits']  # Manual model files (when auto_mapping=0)
