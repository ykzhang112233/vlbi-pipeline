...
#man_fr_file = ['J1925-v1-mod2.fits']
#####################mannual flagging################################
do_flag = 1
fgbchan=[0,0,0,0]
fgechan=[0,0,0,0]
...
fgeif=[0,0,0,0]
fgantennas=[[3],[2],[9],[9]]
fgtimer=[[0,21,38,0,0,21,47,0],[0,23,28,00,0,23,29,0],[0,21,47,0,0,21,53,0],[0,19,43,0,0,19,52,0]]
...
do_uvshift_flag = 1 ###note!! this is from stepn
